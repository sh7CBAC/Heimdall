...
func (a *HostController) initRouter(g *gin.RouterGroup) {
	...
	g.GET("/get/:id", requirePanelPermission("hosts", "view"), a.get)
	...
	g.POST("/update/:id", requirePanelPermission("hosts", "update"), a.update)
	g.POST("/del/:id", requirePanelPermission("hosts", "delete"), a.del)
	g.POST("/setEnable/:id", requirePanelPermission("hosts", "update"), a.setEnable)
