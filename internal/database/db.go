...
// backfillLegacyClientsToOwner assigns legacy/unowned clients to the panel owner.
// It is intentionally idempotent: only rows with a missing owner are updated.
// This covers upgrades/restores from older Heimdall or Sanaei/3x-ui databases
// where clients existed before per-admin ownership scopes were introduced.
