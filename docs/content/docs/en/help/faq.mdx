...
[GitHub](https://github.com/sh7CBAC/Heimdall).
...
[releases page](https://github.com/sh7CBAC/Heimdall/releases).
...
[GitHub](https://github.com/sh7CBAC/Heimdall/issues). For common problems, start
