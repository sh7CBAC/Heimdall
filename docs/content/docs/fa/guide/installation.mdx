...
bash <(curl -Ls https://raw.githubusercontent.com/sh7CBAC/Heimdall/main/install.sh) v3.4.0
```
...
[صفحهٔ releases](https://github.com/sh7CBAC/Heimdall/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/sh7CBAC/Heimdall/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/sh7CBAC/Heimdall/tree/main/deploy) در مخزن
