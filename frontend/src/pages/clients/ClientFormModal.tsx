...
export default function ClientFormModal({
  ...
  useEffect(() => {
    ...
    setForm((prev) =>
      RandomUtil.isShadowsocks2022Password(prev.password, ss2022Method)
        ...
        : {
            ...prev,
            password: RandomUtil.randomShadowsocksPassword(ss2022Method),
          },
    );
  }, [ss2022Method]);
  ...
  async function onSubmit() {
    ...
    const validated = schema.safeParse({
      ...
      downloadMbps: form.downloadMbps,
      tgId: form.tgId,
      group: form.group,
                      ...
                      <Col xs={24} md={12}>
                        ...
                        >
                          <InputNumber
                            ...
                            style={{ width: "100%" }}
                            onChange={(v) =>
                              update("downloadMbps", Number(v) || 0)
                            }
                          />
                        </Form.Item>
                      </Col>
                        ...
                        <Form.Item label={t("pages.clients.uuid")}>
                          <Space.Compact style={{ display: "flex" }}>
                            ...
                            <Button
                              icon={<ReloadOutlined />}
                              onClick={() =>
                                update("uuid", RandomUtil.randomUUID())
                              }
                            />
                          </Space.Compact>
                        </Form.Item>
                        ...
                        <Form.Item label={t("pages.clients.hysteriaAuth")}>
                          <Space.Compact style={{ display: "flex" }}>
                            ...
                            <Button
                              icon={<ReloadOutlined />}
                              onClick={() =>
                                update("auth", RandomUtil.randomLowerAndNum(16))
                              }
                            />
                          </Space.Compact>
                        </Form.Item>
