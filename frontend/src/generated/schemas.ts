...
export const SCHEMAS: Record<string, unknown> = {
  "AllSetting": {
    "description": "AllSetting contains all configuration settings for the HEIMDALL panel including web server, Telegram bot, and subscription settings.",
    "properties": {
      "datepicker": {
  ...
  "User": {
    "description": "User represents a user account in the HEIMDALL panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
